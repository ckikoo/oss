...
type IBucketRepo interface {
	...
	UpdateBucket(ctx context.Context, userID int64, id int64, name string, update *do.UpdateBucket) (*do.BucketDo, error)
	DeleteBucket(ctx context.Context, userID int64, id int64, name string) error
