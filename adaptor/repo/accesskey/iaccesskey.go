...
type IAccessKeyRepo interface {
	...
	UpdateStatus(ctx context.Context, userID int64, accessKey string, status int32) (*do.AccessKeyDo, error)
	DeleteAccessKey(ctx context.Context, userID int64, accessKey string) error
}
